...
def generate_erdos_renyi(p, edge_prob=0.03, lower_weight=0.5, upper_weight=1.0, spread_diag=[1, np.sqrt(3)], random_state=2022):
...
def generate_data(p, n_prop_to_p, Sigma, N=1, random_state=2022):
    Xs = []
